...
struct task_struct {
	...
	struct list_head sjf_list_item;
	struct list_head rms_list_item;
	...
	unsigned int rms_time_slice;
	unsigned int sjf_time_slice;
...
extern int sjf_time_slice;
extern int rms_time_slice;
#endif /* __KERNEL__ */
