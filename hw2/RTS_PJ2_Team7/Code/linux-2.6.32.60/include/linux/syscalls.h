...
asmlinkage long sys_sched_sjf_getquantum(void);
asmlinkage long sys_sched_sjf_setquantum(unsigned int quantum);
asmlinkage long sys_sched_rms_getquantum(void);
asmlinkage long sys_sched_rms_setquantum(unsigned int quantum);
